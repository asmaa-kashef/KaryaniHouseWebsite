...
export default function ProjectDetail() {
    ...
    useEffect(() => {
        fetch('/data/constructionproject.json')
            ...
            .then(data => {
                setProject(data[0]); // Adjust this if you want to select by slug
                setLoading(false);
            })
            .catch(() => {
    ...
    const mainImages = (project.images || []).map(img => ({
        original: img,
        thumbnail: img
    }));

    const architectImages = (project.architectImages || []).map(img => ({
        original: img,
        thumbnail: img
    }));
                ...
                <div className="auto-container" style={{ maxWidth: 1200, margin: 'auto' }}>
                    ...
                    <div className="lower-content" style={{ display: 'flex', gap: 40, flexWrap: 'wrap' }}>
                        ...
                        <div
                            ...
                            style={{ flex: '1 1 60%', minWidth: 300, backgroundColor: '#fff', padding: 25, borderRadius: 12, boxShadow: '0 0 12px rgb(0 0 0 / 0.1)' }}
                        >
                            ...
                            <p>This project required full construction from scratch, meeting tight deadlines, and implementing smart systems integration.</p>

                            <ul className="list-style-one" style={{ marginTop: 15, paddingLeft: 20 }}>
                            ...
                            <p>Managed end-to-end construction including permits, foundation, structure, interior work, and smart home installations.</p>

                            <h4 style={{ marginTop: 30 }}>Result</h4>
                            <p>Successfully delivered a modern villa on schedule with smart integrations and premium finishing.</p>
