...
export default function ProjectsPageClient() {
    ...
    // Sync URL with state. This is crucial for maintaining URL state.
    useEffect(() => {
    ...
    return (
        <section style={{ padding: "40px 20px", maxWidth: "1200px", margin: "auto" }}>
                ...
                {paginatedProjects.length === 0 ? (
                    ...
                    paginatedProjects.map(({ img, slug }, index) => (
                        ...
                        >
                            <Image
                                src={img}
                                alt={`${slug} Project by Karyani House in Abu Dhabi`}
                                width={400}
                                height={220}
            ...
            {/* Styles can be moved to a CSS file for better practice */}
            <style>{`
        [role="link"]:hover,
        [role="link"]:focus {
